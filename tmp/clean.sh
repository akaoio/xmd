...
# Remove additional temporary test files found in root
safe_remove "character_test.md" "character test file"
safe_remove "contradiction_test.md" "contradiction test file"
safe_remove "math_test.md" "math test file"
safe_remove "simple.md" "simple test file"
safe_remove "simple_comment.md" "simple comment test file"
safe_remove "simple_test.md" "simple test markdown"
safe_remove "test_comment.md" "test comment file"
safe_remove "test_directive.md" "test directive file"
safe_remove "test_emergency.md" "test emergency file"
safe_remove "test_fix.md" "test fix file"
safe_remove "test_html*.md" "HTML test files"
safe_remove "test_math.md" "test math file"
safe_remove "test_plain.md" "test plain file"
safe_remove "test_output.md" "test output file"
safe_remove "test_no_comments.md" "test no comments file"
safe_remove "test_simple.md" "test simple file"
safe_remove "test_var_syntax.md" "test variable syntax file"

# Remove .xmd test files
safe_remove "test_*.xmd" "XMD test files"
safe_remove "*.xmd" "temporary XMD files"

# Remove debug C files
safe_remove "debug_*.c" "debug C source files"
safe_remove "simple_test.c" "simple test C file"
safe_remove "test_dispatcher.c" "test dispatcher C file"
safe_remove "test_native_basic.c" "test native basic C file"
safe_remove "test_simple_native.c" "test simple native C file"

# Remove test executables
safe_remove "debug_tokens" "debug tokens executable"

# Remove consolidated output files
safe_remove "after_*.txt" "consolidation output files"
safe_remove "baseline_test_output.txt" "baseline test output"
safe_remove "test_*.txt" "test output text files"

# Remove test markdown files with specific names
safe_remove "test_infrastructure_report.md" "infrastructure report"
safe_remove "test_readiness_report.md" "readiness report"

# Remove achievement and protocol files
safe_remove "CONSOLIDATION_ACHIEVEMENT_REPORT.md" "consolidation report"
