...
typedef enum {
    ...
    ERROR_MEMORY = 7,           /**< Memory allocation error */
    ERROR_INVALID_ARGUMENT = 8, /**< Invalid argument error */
    ERROR_FILE_NOT_FOUND = 9,   /**< File not found error */
    ERROR_SYNTAX = 10,          /**< Syntax error */
    ERROR_SECURITY = 11,        /**< Security error */
    ERROR_TIMEOUT = 12          /**< Timeout error */
} ErrorType;
