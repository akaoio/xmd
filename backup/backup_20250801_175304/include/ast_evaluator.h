...
/**
 * @brief Evaluate identifier reference
...
/**
 * @brief Evaluate conditional statement (if/elif/else)
...
/**
 * @brief Evaluate entire AST program and generate output
...
/**
 * @brief Create boolean AST value
...
/**
 * @brief Convert AST value to string representation
 * @param value AST value
 * @return String representation or NULL on error (caller must free)
 */
