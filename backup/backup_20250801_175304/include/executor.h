...
struct executor_context {
    ...
    char* output_buffer;        /**< Output buffer for command results */
    size_t output_capacity;     /**< Capacity of output buffer */
    size_t output_size;         /**< Current size of output data */
    int last_exit_code;         /**< Exit code of last executed command */
};
