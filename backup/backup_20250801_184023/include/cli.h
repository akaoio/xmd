...
typedef enum {
    ...
    CLI_CMD_FORMAT = 7,     ///< Format command
    CLI_CMD_MINIFY = 8,     ///< Minify command
    CLI_CMD_SERVER = 9,     ///< Server command
    CLI_CMD_BENCHMARK = 10, ///< Benchmark command
    CLI_CMD_INSTALL = 11,   ///< Install command
    CLI_CMD_UNINSTALL = 12, ///< Uninstall command
    CLI_CMD_UPGRADE = 13,   ///< Upgrade command
    CLI_CMD_UNKNOWN = 99    ///< Unknown command
} cli_command_type;
